...
```text
sfdx force:project:create -n dxatscale101-source -t empty --apiversion 51.0
```
...
![](../.gitbook/assets/image%20%2829%29%20%282%29%20%282%29%20%282%29%20%282%29%20%284%29.png)
